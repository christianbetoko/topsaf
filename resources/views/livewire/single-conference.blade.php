...
@section('title', $conference->title . ' | TOP SANTÉ FUKANG')

@section('meta_tags')
    <meta property="og:title" content="{{ $conference->title }}">
    <meta property="og:description" content="{{ Str::limit($conference->description, 160) }}">
    {{-- On utilise directement l'attribut calculé --}}
    <meta property="og:image" content="{{   asset('storage/'.$conference->image) }}">
   <meta property="og:type" content="article">

    <meta name="twitter:title" content="{{ $conference->title }}">
    <meta name="twitter:description" content="{{ Str::limit($conference->description, 160) }}">
    <meta name="twitter:image" content="{{ asset('storage/'.$conference->image) }}">
					...
					<div class="col-lg-5 col-md-5 col-12">
						<div class="breadcrumbs-menu">
							<ul>
								...
								<li><a href="{{ route('conferences') }}">Conférences</a><i class="fa fa-angle-double-right"></i></li>
								<li class="active"><a href="{{ route('conference', $conference->slug) }}">{{ $conference->title }}</a></li>
							</ul>
						</div>	
					</div>
				</div>
									...
									<div class="single-head">
										...
										<div class="blog-title-meta">
											...
											<div class="blog-meta">
												...
												<span><i class="fa fa-calendar"></i>{{ \Carbon\Carbon::parse($conference->date)->format('d/m/Y') }}</span>
												<span><i class="fa fa-money"></i>{{ $conference->price}} </span>
											</div>
											...
											<div class="row">
												...
												<div class="col-lg-4 col-md-4 col-12">
													<div class="blog-share share-tag">
														...
														<a href="{{ route('inscription-conference', $conference->slug) }}"> <button class="btn btn-sm btn-outline-primary border-11" ><i class="fa fa-file"></i> S'inscrire</button></a>
...
<script>
    ...
    const lienComplet = "{{ $conference->video_url }}";
