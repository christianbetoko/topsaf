<div>
				...
				<div class="row">
					...
					<div class="col-lg-12 col-md-12 col-12">
						<div class="breadcrumbs-content">
							<h2>INSCRIPTION A LA FORMATION: {{ $formation->title }}</h2>
    ...
    <div class="contact-form">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-12 col-12">
                <div class="form-group">
                    <input class="form-control @error('date_naissance') is-invalid @enderror" wire:model="date_naissance" type="date" name="date_naissance" placeholder="Date de naissance *" required="required">
